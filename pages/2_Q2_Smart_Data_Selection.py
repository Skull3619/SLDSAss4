...
if run_q2:
    rows = []
    for s in strategies:
        rows.append(evaluate_subset_strategy(bundle.df, bundle.numeric_cols, bundle.target_col, budget=budget, strategy=s, baseline_model=baseline_model, oversample_train=oversample, random_state=int(random_state)))
